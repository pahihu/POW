...
VAR    
  ...
  PSectionHeader:                      Global.PSectionHeader;
...
PROCEDURE NextLine*                   (VAR ActLine:        Global.ScreenLineP;
...
BEGIN;
  ...
  IF Global.PMyDOS_Header#NIL THEN                         (* *.exe or *.dll file *)
    ...
    Strings.Append(ActLine^.Text, SYSTEM.VAL(String4T, Global.PMyDOS_Header^.e_magic));
    ActLine^.Text[Strings.Length(ActLine^.Text)-1] := 0X;
    ActLine^.Format := Global.Text01;
    NextLine(ActLine, NumberOfCol, NumberOfLines);
        
    COPY (Line053, ActLine^.Text);
    Strings.UHexStr(Global.PMyDOS_Header^.e_cblp, 2, MyChars);
    Strings.RightAlign(MyChars, 10);
    Strings.Append(ActLine^.Text, MyChars);
    NextLine(ActLine, NumberOfCol, NumberOfLines);
        
    COPY (Line054, ActLine^.Text);
    Strings.UHexStr(Global.PMyDOS_Header^.e_cp, 2, MyChars);
    Strings.RightAlign(MyChars, 10);
    Strings.Append(ActLine^.Text, MyChars);
    NextLine(ActLine, NumberOfCol, NumberOfLines);
        
    COPY (Line055, ActLine^.Text);
    Strings.UHexStr(Global.PMyDOS_Header^.e_crlc, 2, MyChars);
    Strings.RightAlign(MyChars, 10);
    Strings.Append(ActLine^.Text, MyChars);
    NextLine(ActLine, NumberOfCol, NumberOfLines);
        
    COPY (Line056, ActLine^.Text);
    Strings.UHexStr(Global.PMyDOS_Header^.e_cparhdr, 2, MyChars);
    Strings.RightAlign(MyChars, 10);
    Strings.Append(ActLine^.Text, MyChars);
    NextLine(ActLine, NumberOfCol, NumberOfLines);
        
    COPY (Line057, ActLine^.Text);
    Strings.UHexStr(Global.PMyDOS_Header^.e_minalloc, 2, MyChars);
    Strings.RightAlign(MyChars, 10);
    Strings.Append(ActLine^.Text, MyChars);
    NextLine(ActLine, NumberOfCol, NumberOfLines);
        
    COPY (Line058, ActLine^.Text);
    Strings.UHexStr(Global.PMyDOS_Header^.e_maxalloc, 2, MyChars);
    Strings.RightAlign(MyChars, 10);
    Strings.Append(ActLine^.Text, MyChars);
    NextLine(ActLine, NumberOfCol, NumberOfLines);
        
    COPY (Line059, ActLine^.Text);
    Strings.UHexStr(Global.PMyDOS_Header^.e_ss, 2, MyChars);
    Strings.RightAlign(MyChars, 10);
    Strings.Append(ActLine^.Text, MyChars);
    NextLine(ActLine, NumberOfCol, NumberOfLines);
        
    COPY (Line060, ActLine^.Text);
    Strings.UHexStr(Global.PMyDOS_Header^.e_sp, 2, MyChars);
    Strings.RightAlign(MyChars, 10);
    Strings.Append(ActLine^.Text, MyChars);
    NextLine(ActLine, NumberOfCol, NumberOfLines);
        
    COPY (Line061, ActLine^.Text);
    Strings.UHexStr(Global.PMyDOS_Header^.e_csum, 2, MyChars);
    Strings.RightAlign(MyChars, 10);
    Strings.Append(ActLine^.Text, MyChars);
    NextLine(ActLine, NumberOfCol, NumberOfLines);
        
    COPY (Line062, ActLine^.Text);
    Strings.UHexStr(Global.PMyDOS_Header^.e_ip, 2, MyChars);
    Strings.RightAlign(MyChars, 10);
    Strings.Append(ActLine^.Text, MyChars);
    NextLine(ActLine, NumberOfCol, NumberOfLines);
        
    COPY (Line063, ActLine^.Text);
    Strings.UHexStr(Global.PMyDOS_Header^.e_cs, 2, MyChars);
    Strings.RightAlign(MyChars, 10);
    Strings.Append(ActLine^.Text, MyChars);
    NextLine(ActLine, NumberOfCol, NumberOfLines);
        
    COPY (Line064, ActLine^.Text);
    Strings.UHexStr(Global.PMyDOS_Header^.e_lfarlc, 2, MyChars);
    Strings.RightAlign(MyChars, 10);
    Strings.Append(ActLine^.Text, MyChars);
    NextLine(ActLine, NumberOfCol, NumberOfLines);
        
    COPY (Line065, ActLine^.Text);
    Strings.UHexStr(Global.PMyDOS_Header^.e_ovno, 2, MyChars);
    Strings.RightAlign(MyChars, 10);
    Strings.Append(ActLine^.Text, MyChars);
    NextLine(ActLine, NumberOfCol, NumberOfLines);
        
    COPY (Line066, ActLine^.Text);
    Strings.UHexStr(Global.PMyDOS_Header^.e_res[0], 2, MyChars);
    Strings.RightAlign(MyChars, 10);
    Strings.Append(ActLine^.Text, MyChars);
    NextLine(ActLine, NumberOfCol, NumberOfLines);
        
    COPY (Line067, ActLine^.Text);
    Strings.UHexStr(Global.PMyDOS_Header^.e_oemid, 2, MyChars);
    Strings.RightAlign(MyChars, 10);
    Strings.Append(ActLine^.Text, MyChars);
    NextLine(ActLine, NumberOfCol, NumberOfLines);
        
    COPY (Line068, ActLine^.Text);
    Strings.UHexStr(Global.PMyDOS_Header^.e_oeminfo, 2, MyChars);
    Strings.RightAlign(MyChars, 10);
    Strings.Append(ActLine^.Text, MyChars);
    NextLine(ActLine, NumberOfCol, NumberOfLines);
        
    COPY (Line069, ActLine^.Text);
    Strings.UHexStr(Global.PMyDOS_Header^.e_res2[0], 2, MyChars);
    Strings.RightAlign(MyChars, 10);
    Strings.Append(ActLine^.Text, MyChars);
    NextLine(ActLine, NumberOfCol, NumberOfLines);
        
    COPY (Line070, ActLine^.Text);
    Strings.UHexStr(Global.PMyDOS_Header^.e_lfanew, 2, MyChars);
    Strings.RightAlign(MyChars, 10);
    Strings.Append(ActLine^.Text, MyChars);
    NextLine(ActLine, NumberOfCol, NumberOfLines);
  ...
  END (* IF Global.PMyDOS_Header#NIL *);
      
  COPY (Line080, ActLine^.Text);
  Strings.Append(ActLine^.Text, SYSTEM.VAL(String4T, Global.PMyNT_Header^.Signature));
  ActLine^.Format  := Global.Header1;
  NextLine(ActLine, NumberOfCol, NumberOfLines);
  ...
  ActLine^.Format  := Global.Text01;
  Strings.UHexStr(Global.PMyNT_Header^.FileHeader.Machine, 2, MyChars);
  Strings.RightAlign(MyChars, 10);
  Strings.Append(ActLine^.Text, MyChars);
  CASE Global.PMyNT_Header^.FileHeader.Machine OF
  ...
  Strings.Str(Global.PMyNT_Header^.FileHeader.NumberOfSections, MyChars);
  Strings.RightAlign(MyChars, 9);
  Strings.Append(ActLine^.Text, MyChars);
  NextLine(ActLine, NumberOfCol, NumberOfLines);
      
  COPY (Line084, ActLine^.Text);
  Strings.UHexStr(Global.PMyNT_Header^.FileHeader.TimeDateStamp, 4, MyChars);
  Strings.RightAlign(MyChars, 10);
  Strings.Append(ActLine^.Text, MyChars);
  NextLine(ActLine, NumberOfCol, NumberOfLines);
  ...
  Strings.Str(Global.PMyNT_Header^.FileHeader.NumberOfSymbols, MyChars);
  Strings.RightAlign(MyChars, 9);
  Strings.Append(ActLine^.Text, MyChars);
  NextLine(ActLine, NumberOfCol, NumberOfLines);
      
  COPY (Line087, ActLine^.Text);
  Strings.UHexStr(Global.PMyNT_Header^.FileHeader.SizeOfOptionalHeader, 2, MyChars);
  Strings.RightAlign(MyChars, 10);
  Strings.Append(ActLine^.Text, MyChars);
  NextLine(ActLine, NumberOfCol, NumberOfLines);
      
  COPY (Line088, ActLine^.Text);
  Strings.UHexStr(Global.PMyNT_Header^.FileHeader.Characteristics, 2, MyChars);
  Strings.RightAlign(MyChars, 10);
  Strings.Append(ActLine^.Text, MyChars);
  NextLine(ActLine, NumberOfCol, NumberOfLines);
  
  IF SYSTEM.BIT(LONG(Global.PMyNT_Header^.FileHeader.Characteristics),  0) THEN
    COPY (Line200, ActLine^.Text);
    NextLine(ActLine, NumberOfCol, NumberOfLines);
  END;
  IF SYSTEM.BIT(LONG(Global.PMyNT_Header^.FileHeader.Characteristics),  1) THEN
    COPY (Line201, ActLine^.Text);
    NextLine(ActLine, NumberOfCol, NumberOfLines);
  END;
  IF SYSTEM.BIT(LONG(Global.PMyNT_Header^.FileHeader.Characteristics),  2) THEN
    COPY (Line202, ActLine^.Text);
    NextLine(ActLine, NumberOfCol, NumberOfLines);
  END;
  IF SYSTEM.BIT(LONG(Global.PMyNT_Header^.FileHeader.Characteristics),  3) THEN
    COPY (Line203, ActLine^.Text);
    NextLine(ActLine, NumberOfCol, NumberOfLines);
  END;
  IF SYSTEM.BIT(LONG(Global.PMyNT_Header^.FileHeader.Characteristics),  4) THEN
    COPY (Line204, ActLine^.Text);
    NextLine(ActLine, NumberOfCol, NumberOfLines);
  END;
  IF SYSTEM.BIT(LONG(Global.PMyNT_Header^.FileHeader.Characteristics),  6) THEN
    COPY (Line206, ActLine^.Text);
    NextLine(ActLine, NumberOfCol, NumberOfLines);
  END;
  IF SYSTEM.BIT(LONG(Global.PMyNT_Header^.FileHeader.Characteristics),  7) THEN
    COPY (Line207, ActLine^.Text);
    NextLine(ActLine, NumberOfCol, NumberOfLines);
  END;
  IF SYSTEM.BIT(LONG(Global.PMyNT_Header^.FileHeader.Characteristics),  8) THEN
    COPY (Line208, ActLine^.Text);
    NextLine(ActLine, NumberOfCol, NumberOfLines);
  END;
  IF SYSTEM.BIT(LONG(Global.PMyNT_Header^.FileHeader.Characteristics),  9) THEN
    COPY (Line209, ActLine^.Text);
    NextLine(ActLine, NumberOfCol, NumberOfLines);
  END;
  IF SYSTEM.BIT(LONG(Global.PMyNT_Header^.FileHeader.Characteristics), 10) THEN
    COPY (Line210, ActLine^.Text);
    NextLine(ActLine, NumberOfCol, NumberOfLines);
  END;
  IF SYSTEM.BIT(LONG(Global.PMyNT_Header^.FileHeader.Characteristics), 12) THEN
    COPY (Line212, ActLine^.Text);
    NextLine(ActLine, NumberOfCol, NumberOfLines);
  END;
  IF SYSTEM.BIT(LONG(Global.PMyNT_Header^.FileHeader.Characteristics), 13) THEN
    COPY (Line213, ActLine^.Text);
    NextLine(ActLine, NumberOfCol, NumberOfLines);
  END;
  IF SYSTEM.BIT(LONG(Global.PMyNT_Header^.FileHeader.Characteristics), 14) THEN
    COPY (Line214, ActLine^.Text);
    NextLine(ActLine, NumberOfCol, NumberOfLines);
  END;
  IF SYSTEM.BIT(LONG(Global.PMyNT_Header^.FileHeader.Characteristics), 15) THEN
  ...
  IF Global.PMyNT_Header^.FileHeader.SizeOfOptionalHeader>0 THEN
    COPY (LineEmpty, ActLine^.Text);
    NextLine(ActLine, NumberOfCol, NumberOfLines);
    ...
    Strings.UHexStr(Global.PMyNT_Header^.OptionalHeader.Magic, 2, MyChars);
    Strings.RightAlign(MyChars, 10);
    Strings.Append(ActLine^.Text, MyChars);
    NextLine(ActLine, NumberOfCol, NumberOfLines);
        
    COPY (Line112, ActLine^.Text);
    Strings.Str(SYSTEM.VAL(INTEGER, Global.PMyNT_Header^.OptionalHeader.MajorLinkerVersion), MyChars);
    Strings.Append(ActLine^.Text, MyChars);
    Strings.AppendChar(ActLine^.Text, ".");
    Strings.Str(SYSTEM.VAL(INTEGER, Global.PMyNT_Header^.OptionalHeader.MinorLinkerVersion), MyChars);
    Strings.Append(ActLine^.Text, MyChars);
    NextLine(ActLine, NumberOfCol, NumberOfLines);
        
    COPY (Line114, ActLine^.Text);
    Strings.UHexStr(Global.PMyNT_Header^.OptionalHeader.SizeOfCode, 4, MyChars);
    Strings.RightAlign(MyChars, 10);
    Strings.Append(ActLine^.Text, MyChars);
    NextLine(ActLine, NumberOfCol, NumberOfLines);
        
    COPY (Line115, ActLine^.Text);
    Strings.UHexStr(Global.PMyNT_Header^.OptionalHeader.SizeOfInitializedData, 4, MyChars);
    Strings.RightAlign(MyChars, 10);
    Strings.Append(ActLine^.Text, MyChars);
    NextLine(ActLine, NumberOfCol, NumberOfLines);
        
    COPY (Line116, ActLine^.Text);
    Strings.UHexStr(Global.PMyNT_Header^.OptionalHeader.SizeOfUninitializedData, 4, MyChars);
    Strings.RightAlign(MyChars, 10);
    Strings.Append(ActLine^.Text, MyChars);
    NextLine(ActLine, NumberOfCol, NumberOfLines);
        
    COPY (Line117, ActLine^.Text);
    Strings.UHexStr(Global.PMyNT_Header^.OptionalHeader.AddressOfEntryPoint, 4, MyChars);
    Strings.RightAlign(MyChars, 10);
    Strings.Append(ActLine^.Text, MyChars);
    NextLine(ActLine, NumberOfCol, NumberOfLines);
        
    COPY (Line118, ActLine^.Text);
    Strings.UHexStr(Global.PMyNT_Header^.OptionalHeader.BaseOfCode, 4, MyChars);
    Strings.RightAlign(MyChars, 10);
    Strings.Append(ActLine^.Text, MyChars);
    NextLine(ActLine, NumberOfCol, NumberOfLines);
    ...
    Strings.UHexStr(Global.PMyNT_Header^.OptionalHeader.ImageBase, 4, MyChars);
    Strings.RightAlign(MyChars, 10);
    Strings.Append(ActLine^.Text, MyChars);
    ActLine^.Format := Global.Header3;
    NextLine(ActLine, NumberOfCol, NumberOfLines);
    ...
    ActLine^.Format := Global.Text01;
    Strings.UHexStr(Global.PMyNT_Header^.OptionalHeader.SectionAlignment, 4, MyChars);
    Strings.RightAlign(MyChars, 10);
    Strings.Append(ActLine^.Text, MyChars);
    NextLine(ActLine, NumberOfCol, NumberOfLines);
  
    COPY (Line123, ActLine^.Text);
    Strings.UHexStr(Global.PMyNT_Header^.OptionalHeader.FileAlignment, 4, MyChars);
    Strings.RightAlign(MyChars, 10);
    Strings.Append(ActLine^.Text, MyChars);
    NextLine(ActLine, NumberOfCol, NumberOfLines);
  
    COPY (Line124, ActLine^.Text);
    Strings.Str(Global.PMyNT_Header^.OptionalHeader.MajorOperatingSystemVersion, MyChars);
    Strings.Append(ActLine^.Text, MyChars);
    Strings.AppendChar(ActLine^.Text, ".");
    Strings.Str(Global.PMyNT_Header^.OptionalHeader.MinorOperatingSystemVersion, MyChars);
    Strings.Append(ActLine^.Text, MyChars);
    NextLine(ActLine, NumberOfCol, NumberOfLines);
  
    COPY (Line126, ActLine^.Text);
    Strings.Str(Global.PMyNT_Header^.OptionalHeader.MajorImageVersion, MyChars);
    Strings.Append(ActLine^.Text, MyChars);
    Strings.AppendChar(ActLine^.Text, ".");
    Strings.Str(Global.PMyNT_Header^.OptionalHeader.MinorImageVersion, MyChars);
    Strings.Append(ActLine^.Text, MyChars);
    NextLine(ActLine, NumberOfCol, NumberOfLines);
  
    COPY (Line128, ActLine^.Text);
    Strings.Str(Global.PMyNT_Header^.OptionalHeader.MajorSubsystemVersion, MyChars);
    Strings.Append(ActLine^.Text, MyChars);
    Strings.AppendChar(ActLine^.Text, ".");
    Strings.Str(Global.PMyNT_Header^.OptionalHeader.MinorSubsystemVersion, MyChars);
    Strings.Append(ActLine^.Text, MyChars);
    NextLine(ActLine, NumberOfCol, NumberOfLines);
  
    COPY (Line130, ActLine^.Text);
    Strings.UHexStr(Global.PMyNT_Header^.OptionalHeader.Win32VersionValue, 4, MyChars);
    Strings.RightAlign(MyChars, 10);
    Strings.Append(ActLine^.Text, MyChars);
    NextLine(ActLine, NumberOfCol, NumberOfLines);
  
    COPY (Line131, ActLine^.Text);
    Strings.UHexStr(Global.PMyNT_Header^.OptionalHeader.SizeOfImage, 4, MyChars);
    Strings.RightAlign(MyChars, 10);
    Strings.Append(ActLine^.Text, MyChars);
    NextLine(ActLine, NumberOfCol, NumberOfLines);
  
    COPY (Line132, ActLine^.Text);
    Strings.UHexStr(Global.PMyNT_Header^.OptionalHeader.SizeOfHeaders, 4, MyChars);
    Strings.RightAlign(MyChars, 10);
    Strings.Append(ActLine^.Text, MyChars);
    NextLine(ActLine, NumberOfCol, NumberOfLines);
  
    COPY (Line133, ActLine^.Text);
    Strings.UHexStr(Global.PMyNT_Header^.OptionalHeader.CheckSum, 4, MyChars);
    Strings.RightAlign(MyChars, 10);
    Strings.Append(ActLine^.Text, MyChars);
    NextLine(ActLine, NumberOfCol, NumberOfLines);
  
    COPY (Line134, ActLine^.Text);
    Strings.UHexStr(Global.PMyNT_Header^.OptionalHeader.Subsystem, 2, MyChars);
    Strings.RightAlign(MyChars, 10);
    Strings.Append(ActLine^.Text, MyChars);
    CASE Global.PMyNT_Header^.OptionalHeader.Subsystem OF
    ...
    Strings.UHexStr(Global.PMyNT_Header^.OptionalHeader.DllCharacteristics, 2, MyChars);
    Strings.RightAlign(MyChars, 10);
    Strings.Append(ActLine^.Text, MyChars);
    NextLine(ActLine, NumberOfCol, NumberOfLines);

    IF SYSTEM.BIT(LONG(Global.PMyNT_Header^.OptionalHeader.DllCharacteristics),  0) THEN
      COPY (Line300, ActLine^.Text);
      NextLine(ActLine, NumberOfCol, NumberOfLines);
    END;
    IF SYSTEM.BIT(LONG(Global.PMyNT_Header^.OptionalHeader.DllCharacteristics),  1) THEN
      COPY (Line300, ActLine^.Text);
      NextLine(ActLine, NumberOfCol, NumberOfLines);
    END;
    IF SYSTEM.BIT(LONG(Global.PMyNT_Header^.OptionalHeader.DllCharacteristics),  2) THEN
      COPY (Line300, ActLine^.Text);
      NextLine(ActLine, NumberOfCol, NumberOfLines);
    END;
    IF SYSTEM.BIT(LONG(Global.PMyNT_Header^.OptionalHeader.DllCharacteristics),  3) THEN
      COPY (Line300, ActLine^.Text);
      NextLine(ActLine, NumberOfCol, NumberOfLines);
    END;
    IF SYSTEM.BIT(LONG(Global.PMyNT_Header^.OptionalHeader.DllCharacteristics), 11) THEN
      COPY (Line311, ActLine^.Text);
      NextLine(ActLine, NumberOfCol, NumberOfLines);
    END;
    IF SYSTEM.BIT(LONG(Global.PMyNT_Header^.OptionalHeader.DllCharacteristics), 13) THEN
      COPY (Line313, ActLine^.Text);
      NextLine(ActLine, NumberOfCol, NumberOfLines);
    END;
    IF SYSTEM.BIT(LONG(Global.PMyNT_Header^.OptionalHeader.DllCharacteristics), 15) THEN
      COPY (Line315, ActLine^.Text);
      NextLine(ActLine, NumberOfCol, NumberOfLines);
    END;
  
    COPY (Line136, ActLine^.Text);
    Strings.UHexStr(Global.PMyNT_Header^.OptionalHeader.SizeOfStackReserve, 4, MyChars);
    Strings.RightAlign(MyChars, 10);
    Strings.Append(ActLine^.Text, MyChars);
    NextLine(ActLine, NumberOfCol, NumberOfLines);
  
    COPY (Line137, ActLine^.Text);
    Strings.UHexStr(Global.PMyNT_Header^.OptionalHeader.SizeOfStackCommit, 4, MyChars);
    Strings.RightAlign(MyChars, 10);
    Strings.Append(ActLine^.Text, MyChars);
    NextLine(ActLine, NumberOfCol, NumberOfLines);
  
    COPY (Line138, ActLine^.Text);
    Strings.UHexStr(Global.PMyNT_Header^.OptionalHeader.SizeOfHeapReserve, 4, MyChars);
    Strings.RightAlign(MyChars, 10);
    Strings.Append(ActLine^.Text, MyChars);
    NextLine(ActLine, NumberOfCol, NumberOfLines);
  
    COPY (Line139, ActLine^.Text);
    Strings.UHexStr(Global.PMyNT_Header^.OptionalHeader.SizeOfHeapCommit, 4, MyChars);
    Strings.RightAlign(MyChars, 10);
    Strings.Append(ActLine^.Text, MyChars);
    NextLine(ActLine, NumberOfCol, NumberOfLines);
  
    COPY (Line140, ActLine^.Text);
    Strings.UHexStr(Global.PMyNT_Header^.OptionalHeader.LoaderFlags, 4, MyChars);
    Strings.RightAlign(MyChars, 10);
    Strings.Append(ActLine^.Text, MyChars);
    NextLine(ActLine, NumberOfCol, NumberOfLines);
  
    COPY (Line141, ActLine^.Text);
    Strings.UHexStr(Global.PMyNT_Header^.OptionalHeader.NumberOfRvaAndSizes, 4, MyChars);
    Strings.RightAlign(MyChars, 10);
    Strings.Append(ActLine^.Text, MyChars);
    NextLine(ActLine, NumberOfCol, NumberOfLines);
    ...
    FOR i:=0 TO WinNT.IMAGE_NUMBEROF_DIRECTORY_ENTRIES-1 DO
      ...
      ELSE
        Strings.UHexStr(Global.PMyNT_Header^.OptionalHeader.DataDirectory[i].VirtualAddress, 4, MyChars);
        Strings.RightAlign(MyChars, 10);
        Strings.Append(ActLine^.Text, MyChars);
        Strings.UHexStr(Global.PMyNT_Header^.OptionalHeader.DataDirectory[i].Size, 4, MyChars);
        Strings.RightAlign(MyChars, 20);
        Strings.Append(ActLine^.Text, MyChars);
      END;
      NextLine(ActLine, NumberOfCol, NumberOfLines);
    END (* FOR i:=0 To ... *);
  END (* IF Global.PMyNT_Header^.FileHeader.SizeOfOptionalHeader>0 *);
  ...
  ActLine^.Format  := Global.Text01;
  PSectionHeader   := Global.FirstSectionHeader;
  FOR i:=1 TO Global.PMyNT_Header^.FileHeader.NumberOfSections DO
...
PROCEDURE WriteLinesArchiveLIB*       (FirstLineP:         Global.ScreenLineP;
                                       VAR NumberOfCol:    LONGINT)
                                      :                    LONGINT;
...
BEGIN;
  ...
  ActLine^.Usage   :=  0;
  NumberOfLines    :=  0;
  MyPointer        := Global.MyFileDescription.lpFileBase;
  ...
  ActLine^.Format  := Global.Text01;
  Strings.Append(ActLine^.Text, Global.PArchiveFileSignature^);
  NextLine(ActLine, NumberOfCol, NumberOfLines);
  INC(MyPointer, 8);
  ...
  DisplayArchiveMemberHeader(Global.PMyImageArchiveHeader1);
  ...
  Global.PMyImageArchiveHeader2      := SYSTEM.VAL(WinNT.PIMAGE_ARCHIVE_MEMBER_HEADER, MyPointer);

  COPY (Line510, ActLine^.Text);                            (* Second Linker Member *)
  NextLine(ActLine, NumberOfCol, NumberOfLines);
        
  DisplayArchiveMemberHeader(Global.PMyImageArchiveHeader2);
  ...
  FOR i:=1 TO NumberOfMembers DO;
    ...
    Strings.Append(ActLine^.Text, MyChars);
    NextLine(ActLine, NumberOfCol, NumberOfLines);
    MyPointer2             := Global.MyFileDescription.lpFileBase + PLongInt^[0];
    ...
    Global.FirstSectionHeader^.PSectionHeader   := NIL;
...
(* the file's data are stored in global.mod MyFileDescription                *)
(*                                                                           *)
(* INPUT:                                                                    *)
(*                                                                           *)
(* OUTPUT:                                                                   *)
...
BEGIN
  ...
  MDICreateStruct.szTitle      := SYSTEM.ADR(Global.MDIDumpTitle);
  ...
  Global.hWndDump              := WinUser.SendMessageA(Global.hWndMDIClient, 
                                                       WinUser.WM_MDICREATE, 
                                                       0, 
                                                       SYSTEM.ADR(MDICreateStruct));
  ASSERT(Global.hWndDump#0);

  (* Read Bytes until eof reached, this will be the basis for displaying hexdata *)
  Result := WinBase.ReadFile (Global.MyFileDescription.hFile, SYSTEM.ADR(Global.FileData), Global.BlockLength, Global.FileDataLength, 0);
  Global.ReadFirstBlock (Global.FileData, Global.FileDataLength);
  
  REPEAT
    Result := WinBase.ReadFile (Global.MyFileDescription.hFile, SYSTEM.ADR(Global.FileData), Global.BlockLength, Global.FileDataLength, 0);
    Global.ReadNextBlock (Global.FileData, Global.FileDataLength)
  UNTIL Global.FileDataLength<Global.BlockLength;
  
  (* Read File's DOS Header *)
  MyPointer            := Global.MyFileDescription.lpFileBase;
  Global.PMyDOS_Header := SYSTEM.VAL(WinNT.PIMAGE_DOS_HEADER, MyPointer);

  IF Global.PMyDOS_Header.e_magic=WinNT.IMAGE_DOS_SIGNATURE THEN
    MyPointer            := Global.MyFileDescription.lpFileBase + Global.PMyDOS_Header^.e_lfanew;
    (* Read File's PE Structure *)
    Global.PMyNT_Header  := SYSTEM.VAL(WinNT.PIMAGE_NT_HEADERS, MyPointer);
    IF Global.PMyNT_Header.Signature=WinNT.IMAGE_NT_SIGNATURE THEN
      Global.MyFileDescription.FileType := Global.FileTypeEXE;
    ELSE
      Global.MyFileDescription.FileType := Global.FileTypeUnknown;
      RETURN 0;
    END;
    INC(MyPointer, (SIZE(WinDef.DWORD)+SIZE(WinNT.IMAGE_FILE_HEADER)+LONG(Global.PMyNT_Header.FileHeader.SizeOfOptionalHeader)));
  ELSIF Global.PMyDOS_Header.e_magic=3C21H THEN
    MyPointer                          := Global.MyFileDescription.lpFileBase;
    Global.PArchiveFileSignature       := SYSTEM.VAL(Global.ArchiveFileSignatureP, MyPointer);
    INC(MyPointer, 8);
    Global.PMyImageArchiveHeader1      := SYSTEM.VAL(WinNT.PIMAGE_ARCHIVE_MEMBER_HEADER, MyPointer);
    INC(MyPointer, SIZE(WinNT.IMAGE_ARCHIVE_MEMBER_HEADER));
    Global.PMyImageArchiveHeader2      := SYSTEM.VAL(WinNT.PIMAGE_ARCHIVE_MEMBER_HEADER, MyPointer);
    Global.MyFileDescription.FileType  := Global.FileTypeLIB;
    Global.PMyDOS_Header               := NIL;
    NEW(Global.PMyNT_Header);
    Global.PMyNT_Header                := NIL;
    Global.MyFileDescription.Loaded    := TRUE;
    RETURN 0;
  ELSE
    Global.PMyDOS_Header               := NIL;
    NEW(Global.PMyNT_Header);
    SYSTEM.MOVE(MyPointer, SYSTEM.ADR(Global.PMyNT_Header.FileHeader), SIZE(WinNT.IMAGE_FILE_HEADER));
    Global.MyFileDescription.FileType  := Global.FileTypeOBJ;
    FOR i:=0 TO WinNT.IMAGE_NUMBEROF_DIRECTORY_ENTRIES-1 DO
      Global.PMyNT_Header^.OptionalHeader.DataDirectory[i].VirtualAddress := 0
    END;
    INC(MyPointer, (SIZE(WinNT.IMAGE_FILE_HEADER)+LONG(Global.PMyNT_Header.FileHeader.SizeOfOptionalHeader)));
  END;
  ...
  FOR i:=1 TO Global.PMyNT_Header.FileHeader.NumberOfSections DO
    ...
    ActSectionHeader       := ActSectionHeader^.Next;
    INC(MyPointer, SIZE(WinNT.IMAGE_SECTION_HEADER));
  END (* FOR i:=1 TO Global.PMyNT_Header.FileHeader.NumberOfSections *);  

  (* read Debug Directory *)
  ActDebugDirectory    := Global.FirstDebugDirectory;
  MyPointer            := Global.ImageDirectoryOffset(6, ActSectionHeader^.PSectionHeader);
  IF MyPointer#0 THEN                                      (* COFF *)
    i                    := Global.PMyNT_Header^.OptionalHeader.DataDirectory[6].Size;
